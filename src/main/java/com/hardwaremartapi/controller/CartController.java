...
public class CartController {
  ...
  public ResponseEntity<Cart> removeProductFormCart(@PathVariable("cartId") String cartId) throws InterruptedException, ExecutionException, ResourceNotFoundException{
